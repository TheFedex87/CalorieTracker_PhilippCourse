...
import it.thefedex87.tracker_presentation.search.components.SearchTextField
import it.thefedex87.tracker_presentation.search.components.TrackableFoodItem
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            items(state.trackableFood) { food ->
                TrackableFoodItem(
                    ...
                    onAmountChange = {
                        viewModel.onEvent(
                            SearchEvent.OnAmountForFoodChanged(
                                food.food, it
                            )
                        )
                    },
